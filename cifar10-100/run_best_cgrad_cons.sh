...
python train.py --experiment "cifar10_$(date +%Y%m%d_%H%M%S)" --config ./cifar10_best_cons.yaml --data-path /data/rboone/datasets/cifar10/ --log-wandb --model max_former --lr 0.0015 --time-step 8
